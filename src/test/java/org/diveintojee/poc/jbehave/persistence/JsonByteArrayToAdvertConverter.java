...
public class JsonByteArrayToAdvertConverter implements Converter<byte[], Advert> {
    ...
    public Advert convert(final byte[] source) {
        ...
        try {
            jsonMapper.getDeserializationConfig().without(DeserializationConfig.Feature.FAIL_ON_UNKNOWN_PROPERTIES);
            // System.out.write(source);
            final Advert advert = jsonMapper.readValue(source, Advert.class);
            return advert;
