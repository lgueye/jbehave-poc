...
public class FacadeImpl implements Facade {
    ...
    /**
     * @see org.diveintojee.poc.domain.business.Facade#createAdvert(org.diveintojee.poc.domain.Advert)
     */
    @Override
    ...
    /**
     * @see org.diveintojee.poc.domain.business.Facade#deleteAdvert(java.lang.Long)
     */
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    ...
    /**
     * @see org.diveintojee.poc.domain.business.Facade#findAdvertsByCriteria(org.diveintojee.poc.domain.Advert)
     */
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    ...
    /**
     * @see org.diveintojee.poc.domain.business.Facade#readAdvert(java.lang.Long)
     */
    @Override
    ...
    /**
     * @see org.diveintojee.poc.domain.business.Facade#updateAdvert(org.diveintojee.poc.domain.Advert)
     */
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    ...
    /**
     * @see org.diveintojee.poc.domain.business.Facade#validate(org.diveintojee.poc.domain.AbstractEntity,
     *      org.diveintojee.poc.domain.validation.ValidationContext)
     */
    @Override
